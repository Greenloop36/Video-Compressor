...
def main() -> bool | None:
    ...
    for Module in RequiredModules:
        print(f"\t| \"{Module["Python Name"]}\":", end = " ", flush=True)
        Installed = IsModuleInstalled(Module["Python Name"])

        if not Installed:
            ModulesToInstall.append(Module["Package Name"])
